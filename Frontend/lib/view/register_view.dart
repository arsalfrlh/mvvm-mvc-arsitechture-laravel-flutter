              ...
              child: Column(
                children: [
                  ...
                  SignUpForm(
                    ...
                    register: () async{
                      final response = await authViewmodel.register(nameController.text, emailController.text, passwordController.text);
                      AwesomeDialog(
                        context: context,
                        ...
                        btnOkOnPress: response ? () => Navigator.pushAndRemoveUntil(
                          context, MaterialPageRoute(builder: (context) => HomeView()), (route) => false) : null,
    ...
    return Form(
      child: Column(
        children: [
          ...
          ElevatedButton(
            onPressed: authViewmodel.isLoading ? null : register,
            ...
            child: authViewmodel.isLoading ? const CircularProgressIndicator() : const Text("Continue"),
          )
        ],
      ),
    );
