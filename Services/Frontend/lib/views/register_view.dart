...
import 'package:toko/views/verify_view.dart';
                  ...
                  SignUpForm(
                    ...
                    register: () async{
                      ...
                      AwesomeDialog(
                        ...
                        title: response ? "Sukes" : "Error",
                        desc: authVM.message,
                        btnOkOnPress: (){
                          if(response){
                            Navigator.pushAndRemoveUntil(
                              context, MaterialPageRoute(builder: (context) => VerifyView()), (route) => false);
                          }
                        },
      ...
      child: Column(
        children: [
          ...
          ElevatedButton(
            ...
            child: authVM.isLoading ? Center(child: CircularProgressIndicator(),) : const Text("Continue"),
          )
        ],
      ),
    );
