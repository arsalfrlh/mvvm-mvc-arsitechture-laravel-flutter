...
import 'package:toko/views/upload_view.dart';
            ...
            children: [
              ...
              SizedBox(
                ...
                child: PageView.builder(
                  itemCount: widget.post.postImage.length,
                  onPageChanged: (value) {
                    setState(() {
                      currentIndex = value;
                    });
                  ...
                  itemBuilder: (context, index) {
                    return ClipRRect(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: "http://192.168.0.123:8000/storage/${widget.post.postImage[currentIndex].imagePath}",
                        fit: BoxFit.cover,
              ...
              Row(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      IconButton(onPressed: widget.onComment, icon: Icon(Icons.delete),
                          color: Colors.grey),
                    ],
                  ),
                ],
